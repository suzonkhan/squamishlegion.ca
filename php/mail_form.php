...
// OPTIONS - PLEASE CONFIGURE THESE BEFORE USE!
	...
	$yourEmail = "madirob@telus.net"; // the email address you wish to receive these mails through
	$yourWebsite = "Squamish Legion"; // the name of your website
	$thanksPage = 'http://www.squamishlegion.ca/index.html'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
